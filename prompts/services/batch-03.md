...
1) documentation-package — Exchange Documentation Package  Layout: process
2) multifamily-replacement-properties — Multifamily Replacement Properties  Layout: minimal
3) nnn-retail-replacement-properties — NNN Retail Replacement Properties  Layout: classic
4) industrial-replacement-properties — Industrial Replacement Properties  Layout: detailed
5) dst-replacement-properties — DST Replacement Properties  Layout: focused
6) identification-rules-explainer — Identification Rules Explainer  Layout: comparison
7) [Note: Only 6 services in this batch to complete the 24 total]
